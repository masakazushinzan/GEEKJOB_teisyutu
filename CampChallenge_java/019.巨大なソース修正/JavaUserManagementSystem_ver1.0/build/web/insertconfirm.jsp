...
<html>
    ...
    <body>
        ...
        <%  hs.setAttribute("name", udb.getName());
            hs.setAttribute("year", udb.getYear());
            hs.setAttribute("month", udb.getMonth());
            hs.setAttribute("day", udb.getDay());
            hs.setAttribute("type", udb.getType());
            hs.setAttribute("tell", udb.getTell());
            hs.setAttribute("comment", udb.getComment());
