 ...
 * @author rui
 */
public class hiki_modori2 extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet hiki_modori2</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet hiki_modori2 at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
    }
